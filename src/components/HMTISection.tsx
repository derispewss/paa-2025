...
const HMTISection = () => {
  ...
  return (
    <section id="hmti" className="min-h-screen w-full relative overflow-hidden">
      ...
      {/* content element */}
      <div className="absolute z-30 text-white top-0 left-0 flex flex-col items-center justify-center w-full min-h-screen gap-6 sm:gap-8 lg:gap-10 px-4 sm:px-6 lg:px-8 py-20">
        <h1 className="max-w-4xl title text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center leading-tight">
          3 BIDANG HMTI
        </h1>
        <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-7xl">
